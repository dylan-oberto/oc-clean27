...
const Particuliers = () => {
  ...
  return (
    <div className="pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white mb-8">
                Un accompagnement quotidien pour votre bien-être. De l'entretien de votre maison 
                à la préparation de vos repas, OC'Clean vous propose des services d'aide à domicile 
      ...
      {/* Aide à domicile Section */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Services d'Aide à Domicile</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-2">Ménage et Entretien</h3>
                  <p className="text-gray-600">
                    Notre équipe qualifiée s'occupe de l'entretien régulier de votre domicile : 
                    ménage, dépoussiérage, nettoyage des sols et sanitaires.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Repassage Professionnel</h3>
                  <p className="text-gray-600">
                    Un service de repassage soigné pour tous vos vêtements et linges de maison, 
                    avec possibilité de prise en charge et livraison à domicile.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Préparation des Repas</h3>
                  <p className="text-gray-600">
                    Des repas équilibrés préparés à votre domicile, selon vos goûts et régimes 
                    alimentaires spécifiques. Nous pouvons également faire vos courses.
                  </p>
                </div>
              </div>
            </div>
