...
const services = [
  {
    ...
    alt: "Hall d'immeuble nettoyé professionnellement avec sol brillant et surfaces impeccables",
  ...
  },
  {
    ...
    alt: "Espace de bureau moderne parfaitement entretenu avec surfaces désinfectées",
  ...
  },
  {
    ...
    alt: "Appartement Airbnb entièrement nettoyé et préparé pour l'arrivée des voyageurs",
    link: "/airbnb"
  },
  {
    title: "Commerces",
    ...
    alt: "Intérieur de commerce nettoyé professionnellement avec sol brillant et vitrines étincelantes",
    link: "/services/bureaux"
  },
  {
    ...
    alt: "Cabinet médical désinfecté selon les normes sanitaires avec surfaces stérilisées",
    link: "/services/bureaux"
  },
  {
    ...
    alt: "Salle de classe nettoyée et désinfectée avec tables et chaises parfaitement propres",
    link: "/services/bureaux"
  }
];
...
const certifications = [
  {
    ...
    alt: "Logo de la certification Cradle to Cradle - Économie circulaire"
  },
  {
    image: "https://i.ibb.co/9KW8C9H/eco-cert.png",
    name: "Eco Cert",
    alt: "Logo de la certification Eco Cert - Produits écologiques"
  },
  {
    image: "https://i.ibb.co/tw3jX1hk/fsc.png",
    name: "FSC",
    alt: "Logo de la certification FSC - Gestion durable des forêts"
  },
  {
    image: "https://i.ibb.co/fdSh1DSy/eu-ecolabel.png",
    name: "EU Ecolabel",
    alt: "Logo EU Ecolabel - Label écologique européen"
  }
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-2">
              ...
              <Link
                ...
                aria-label="Découvrir notre démarche écologique et nos engagements environnementaux"
              >
